				...
				<form action="#" method="post">
					<table class="tablebg" cellspacing="1" width="100%">
						<tbody>
									...
									<table style="width: 100%;" cellspacing="1" cellpadding="4" align="center">
										<tbody>
											<tr>
												...
												<td><input class="post" name="email" size="25" tabindex="1" type="text" /></td>
											</tr>
											<tr>
												<td valign="top"><b class="gensmall">Login :</b></td>
												<td><input class="post" name="login" size="25" tabindex="1" type="text" /></td>
											</tr>
											<tr>
											...
											<tr>
												<td valign="top"><b class="gensmall">Mot de passe (confirmation) :</b></td>
							...
							<tr>
								<td class="cat" colspan="2" align="center"><input name="inscription" class="btnmain" value="Inscription" tabindex="5" type="submit" /></td>
							</tr>
						</tbody>
					</table>
				</form>
